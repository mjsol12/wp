...
class McpddPlugin 
{
	...
	function register() {
		// load text domain
		load_plugin_textdomain( 'mcp', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );

		add_action('admin_enqueue_scripts', array($this, 'enqueue'));

		add_action('admin_menu', array($this, 'add_admin_pages'));

		add_action('rest_api_init', array($this, 'add_featured_image_to_rest') );
	...
	function add_admin_pages(){
		add_menu_page( 'MCP Title', 'MCP Empty', 'manage_options', 'mcp_plugin', array( $this, 'admin_index'), 'dashicons-sticky', 5 );
	}
